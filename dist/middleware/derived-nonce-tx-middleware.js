...
var log = debug_1.default('derived-nonce-tx-middleware');
/**
 ...
 */
var DerivedNonceTxMiddleware = /** @class */ (function () {
    function DerivedNonceTxMiddleware(client) {
        this._client = client;
    }
    DerivedNonceTxMiddleware.DeriveAccount = function (txData) {
        var incomingTx = loom_pb_1.Transaction.deserializeBinary(Uint8Array.from(txData));
        var incomingMsgTx = loom_pb_1.MessageTx.deserializeBinary(incomingTx.getData_asU8());
        return address_1.Address.UnmarshalPB(incomingMsgTx.getFrom());
    };
    DerivedNonceTxMiddleware.prototype.Handle = function (txData) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var fromAddress, nonce, tx;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fromAddress = DerivedNonceTxMiddleware.DeriveAccount(txData);
    ...
    DerivedNonceTxMiddleware.prototype.HandleResults = function (results) {
    ...
    return DerivedNonceTxMiddleware;
}());
exports.DerivedNonceTxMiddleware = DerivedNonceTxMiddleware;
//# sourceMappingURL=derived-nonce-tx-middleware.js.map