...
function bootstrapTest(createClient) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var privKey, pubKey, client, account, loomProvider, contractData, ABI, result, web3, contract, signer;
...
tape_1.default('Test Signed Eth Tx Middleware Type 2', function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var _a, client, signer, pubKey, loomProvider, contract, account, addressMapper, ethAddress, from, to, ethersSigner, addressMapped, err_2, callerChainId, middlewaresUsed, tx, err_3;
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            case 0:
